...
copy .env.example file and add your environment information for db connection, for example:

```
DB_CONNECTION=mysql
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=dolci_capricci
DB_USERNAME=root
DB_PASSWORD=root
```
...
Open terminal in this folder and run commands:
